...
public class wonderwoman extends AppCompatActivity {
    private TextView textView;
    private static final String URL_JSON = "https://akabab.github.io/superhero-api/api/id/720.json"; // Reemplaza con tu URL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wonderwoman);
        textView = findViewById(R.id.estadisticasw_txt);

        constraintLayout = (ConstraintLayout) findViewById(R.id.constraintwonder);
        Preferencias preferencias = new Preferencias();
        preferencias.guardarpreferencias(wonderwoman.this,constraintLayout);
