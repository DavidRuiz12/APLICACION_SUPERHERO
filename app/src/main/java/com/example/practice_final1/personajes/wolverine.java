...
public class wolverine extends AppCompatActivity {
    ...
    private static final String URL_JSON = "https://akabab.github.io/superhero-api/api/id/717.json"; // Reemplaza con tu URL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.estadisticasL_txt);

        constraintLayout = (ConstraintLayout) findViewById(R.id.constraintwolverine);
        Preferencias preferencias = new Preferencias();
        preferencias.guardarpreferencias(wolverine.this,constraintLayout);
