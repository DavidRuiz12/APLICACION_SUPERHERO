...
public class sttepenwolf extends AppCompatActivity {
    private TextView textView;
    private static final String URL_JSON = "https://akabab.github.io/superhero-api/api/id/637.json"; // Reemplaza con tu URL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sttepenwolf);
        textView = findViewById(R.id.estadisticasP_txt);

        constraintLayout = (ConstraintLayout) findViewById(R.id.constraintsttepen);

        Preferencias preferencias = new Preferencias();
        preferencias.guardarpreferencias(sttepenwolf.this,constraintLayout);
