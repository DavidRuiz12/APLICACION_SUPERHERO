...
public class spiderman extends AppCompatActivity {
    ...
    private static final String URL_JSON = "https://akabab.github.io/superhero-api/api/id/620.json"; // Reemplaza con tu URL
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.estadisticastxt);

        constraintLayout = (ConstraintLayout) findViewById(R.id.constraintspiderman);

        Preferencias preferencias = new Preferencias();
        preferencias.guardarpreferencias(spiderman.this,constraintLayout);
